...
func (db *DB) FetchAnswer(uid string) (*SecurityAnswer, error) {
...
func (db *DB) StoreAnswer(user, ans string, qid int) error {
...
func (db *DB) FetchQuestions() ([]*SecurityQuestion, error) {
...
func (db *DB) RemoveAnswer(uid string) error {
