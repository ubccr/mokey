...
var Dutch = Config{
	...
	Periods: []FormatPeriod{
		{time.Second, "ongeveer een seconde", "%d seconden"},
		{time.Minute, "ongeveer een minuut", "%d minuten"},
		{time.Hour, "ongeveer een uur", "%d uur"},
		{Day, "één dag", "%d dagen"},
		{Month, "één maand", "%d maanden"},
		{Year, "één jaar", "%d jaar"},
	},
